define(function () {
    return (opt = {}) => {
        ...
        bm.add('sect100', {
            ...
            'custom-name': 'Column',
            content: `
                <div class="container" style="${tableStyleStr}">
                    <div class="row no-gutters" data-gjs-draggable=".container">
                        <div class="col" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                    </div>
                </div>`,
        });
        bm.add('sect50', {
            ...
            content: `
                <div class="container" style="${tableStyleStr}">
                    <div class="row no-gutters" data-gjs-draggable=".container">
                        <div class="col-md-6" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                        <div class="col-md-6" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                    </div>
                </div>`,
        });
        bm.add('sect30', {
            ...
            content: `<div class="container" style="${tableStyleStr}">
                    <div class="row no-gutters" data-gjs-draggable=".container">
                        <div class="col-md-4" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                        <div class="col-md-4" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                        <div class="col-md-4" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                    </div>
                </div>`,
        ...
        bm.add('sect37', {
            ...
            content: `<div class="container" style="${tableStyleStr}">
                    <div class="row no-gutters" data-gjs-draggable=".container">
                        <div class="col-md-4" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                        <div class="col-md-8" data-gjs-draggable=".row" style="${cellStyleStr}"></div>
                    </div>
                </div>`,
        });
        bm.add('button', {
